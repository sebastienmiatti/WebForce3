<?php require '../admin/inc/init.inc.php';
...
// gestion des contenus de la BDD expérience
            ...
            <div class="navbar navbar-inverse navbar-fixed-top scroll-me" id="menu-section" >
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.php"><?= $ligne_utilisateur['prenom'] . ' ' . $ligne_utilisateur['nom'];  ?></a>
                    </div>
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="reseau.php">Contact/Réseau</a></li>
                        </ul>
                    </div>
                ...
                <div class="container">
                            ...
                            <div id="carousel-slider" data-ride="carousel" class="carousel slide animate-in" data-anim-type="fade-in-up">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <h3><?= $ligne_utilisateur['prenom'] . ' ' . $ligne_utilisateur['nom']; ?></h3>
                                        <h3> Développeur web full-stack</h3>
                                        <p>Après différentes expériences professionnelles dans de nombreux domaines</p>
                                        <p>j’ai décidé de me perfectionner dans un domaine que j’affectionne tout particulièrement, le developpement et l'intégration web.</p>
                                        <p>Autodidacte et passionnée d'informatique vous pourrez retrouver ici toutes mes réalisations, expériences et mes compétences lié a cette passion.</p>
                                    </div>
                    ...
                    <div class="row animate-in" data-anim-type="fade-in-up">
                        <div class="col-sm-6 col-sm-offset-3 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2 scroll-me">
                            <p>This line is fixed so you can write anything</p>
                            <div class="social">
                                <a href="https://www.facebook.com/Miattisebastien/" class="btn button-custom btn-custom-one" ><i class="fa fa-facebook "></i></a>
                                <a href="https://twitter.com/SebMiatti" class="btn button-custom btn-custom-one" ><i class="fa fa-twitter"></i></a>
                                <a href="https://www.linkedin.com/in/s%C3%A9bastien-miatti-7b6586145/" class="btn button-custom btn-custom-one" ><i class="fa fa-linkedin "></i></a>
                                <a href="https://codepen.io/tchikito/#" class="btn button-custom btn-custom-one" ><i class="fa fa-codepen"></i></a>
                                <a href="https://github.com/sebastienmiatti" class="btn button-custom btn-custom-one" ><i class="fa fa-github "></i></a>
                            </div>
                    ...
                    <?php while ($ligne_competence = $resultat -> fetch()) : ?>
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="services-wrapper">
                                ...
                                <h3><?= $ligne_competence['titre'];?></h3>
                                <?= $ligne_competence['competence'];?>
                                <?= $ligne_competence['c_niveau'];?>
                            </div>
                        </div>
                    <?php endwhile ?>
