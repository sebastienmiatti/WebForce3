...
<a  class="<?=  ($page == 'Panier') ? 'active' : ''  ?>" href="<?= RACINE_SITE ?>panier.php">Panier<?php if(quantitePanier()) : ?>
<span class="bulle"><?= quantitePanier() ?></span>
<?php endif ?></a>

<?php if(userAdmin()) :	?>
<a  class="<?=  ($page == 'Gestion Boutique') ? 'active' : ''  ?>" href="backoffice/gestion_boutique.php">Gestion Boutique</a>
<a  class="<?=  ($page == 'Gestion Membres') ? 'active' : ''  ?>" href="backoffice/gestion_membres.php">Gestion Membres</a>
<a  class="<?=  ($page == 'Gestion Commandes') ? 'active' : ''  ?>"  href="backoffice/gestion_commandes.php">Gestion Commandes</a>
<?php endif; ?>
